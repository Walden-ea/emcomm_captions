...
ds_noise = load_from_disk("/home/elena/emcomm/datasets/noise_features_resnet_152")
...
noise_tuples, noise_labels = create_exhaustive_tuples(
    np.array(ds_noise["features"]),
    n_distractors=n_distractors,
    epoch=0,
    shuffle=True,
    seed=42,
...
np.savez_compressed(
f"/home/elena/emcomm/emcomm_captions/combined_val/data_{n_distractors}_distractors_combined_with_noise_val.npz",
    wg=wg_tuples,
    wg_labels=wg_labels,
