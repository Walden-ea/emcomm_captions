...
class SymbolGameReinforce(nn.Module):
    ...
    def forward(self, sender_input, labels, receiver_input=None, aux_input=None):
        ...
        # print(interaction)
        # print(interaction.sender_input[0][0])
        # print(torch.argmax(interaction.sender_input[0][0]).item(),',', interaction.message, interaction.receiver_output, interaction.labels)
